...
namespace Wc3_Combat_Game.Entities.Components.Prototype
{
    ...
    public readonly struct UnitPrototype
    {
        ...
        public readonly AbilityPrototype Weapon;
        ...
        public UnitPrototype(AbilityPrototype weapon, float maxHealth, float healthRegen, float radius, float speed, Color fillColor, DrawShape shape)
        {
            Weapon = weapon;
            Life = maxHealth;
        ...
        public UnitPrototype(AbilityPrototype weapon, float maxHealth, float healthRegen, float mana, float manaRegen, float radius, float speed, Color fillColor, DrawShape shape = DrawShape.Square)
