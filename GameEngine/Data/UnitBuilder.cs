    ...
    public class UnitBuilder
    {
        ...
        public static void BuildUnits()
        {
            ...
            var rangedWeapon = new AbilityPrototype("ranged_weapon","Light Death Bolt",
                    ...
                    1.5f,
                    150f,10f);
            var rangedWeaponLight = new AbilityPrototype("ranged_weapon_light","Basic Arrow",
            ...
            var rangedWeaponHeavy = new AbilityPrototype("ranged_weapon_heavy","Death Bolt",
            ...
            var rangedWeaponHeavyFan = new AbilityPrototype("ranged_weapon_heavy_fan","Death Bolt (Fan)",
                    spreadHeavyAction, null,
                    5f,
                    200f,10f);

            var rangedWeaponSnare = new AbilityPrototype("ranged_weapon_snare","Shockwave (Snare)",
            ...
            var enemySprint = new AbilityPrototype("enemy_sprint","Sprint",
                null,
                new BuffAction(IBuffable.BuffType.Speed, 6f, 0.25f),
                3f,
                225f);

            PrototypeManager.RegisterAbility(rangedWeapon);
            PrototypeManager.RegisterAbility(rangedWeaponLight);
            PrototypeManager.RegisterAbility(rangedWeaponHeavy);
            PrototypeManager.RegisterAbility(rangedWeaponHeavyFan);
            PrototypeManager.RegisterAbility(rangedWeaponSnare);
            PrototypeManager.RegisterAbility(enemySprint);
            ...
            unit = new UnitPrototype("boss_enemy","Boss",400f, 0f, 15f, 80f, Color.DarkRed, 4);
            unit = unit.AddWeaponAndRegister(AbilityFactory.CreateInstantWeapon(90f, 2, 20, 0.25f, 0.5f));
            //unit = unit.AddAbility("ranged_weapon_snare");
            unit = unit.AddAbility("enemy_sprint");
            PrototypeManager.RegisterUnit(unit);

            unit = new UnitPrototype("swarmer_enemy","Swarmer",10f, 0.0f, 3f, 25f, Color.OrangeRed, int.MaxValue);
            ...
            unit = unit.AddAbility("ranged_weapon_light");
            PrototypeManager.RegisterUnit(unit);
